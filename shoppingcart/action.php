				...
				if(isset($_POST['get_cart_items']) || isset($_POST['show_cart_details']))
				{
					...
					echo '
						<form action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="post">
							  ...
							  echo '
							  <input type="hidden" name="return" value="localhost/shoppingcart/payment_success.php">
							  <input type="hidden" name="cancel_return" value="localhost/shoppingcart/cancel.php">
